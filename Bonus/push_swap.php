...
function sortList()
{
    ...
    // echo "niveau 1 de \$la type verif : " . implode(' ', $la) . "\n";
    // echo "niveau 1 de \$lb type verif : " . implode(' ', $lb) . "\n";
    // echo "\n";
    ...
    if (count($la) === 3) {
        if ($la[0] > $la[1] && $la[0] < $la[2]) {
            ...
            if ($la[0] === $la[2] || $la[1] > $la[2] || $la[0] > $la[2]) {
                rra();
        ...
        // echo "niveau 3 de \$la type verif : " . implode(' ', $la) . "\n";
        // echo "niveau 3 de \$lb type verif : " . implode(' ', $lb) . "\n";
        // echo "\n";
    }
    ...
    // echo "niveau 4 de \$la type verif : " . implode(' ', $la) . "\n";
    // echo "niveau 4 de \$lb type verif : " . implode(' ', $lb) . "\n";
    // echo "\n";
...
if (isSorted($la)) {
    ...
    echo implode(" ", array_map('strval', $la));
}